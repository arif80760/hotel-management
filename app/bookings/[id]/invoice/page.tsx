...
export default async function InvoicePage({ params }: Props) {
  ...
  // Issued date: computed once from raw ISO, reused everywhere (no double-format)
  ...
  const grossBill   = booking.totalAmount + extraCharge - earlyDeduction - additionalDiscount;
        ...
        <div className="grid grid-cols-2 gap-12 pb-4 border-b border-slate-200">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-600">
              ...
              {" → "}
              {issuedDateISO ? formatInvoiceDate(issuedDateISO) : booking.checkOut}
            </p>
            <p className="text-[11px] text-slate-600">
